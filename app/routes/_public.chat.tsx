...
export default function IndexRoute() {
  ...
  return (
    ...
    <div className="px-12 text-lg md:text-3xl text-center  py-4 md:py-20"> Ask our agent anything about life in 2050.</div>
    <div className="m-auto mt-4 md:mt-20 w-screen md:w-8/12">
