...
export default function ProductsIndexRoute() {
  ...
  return (
    ...
    <div className="grid py-2 xl:h-[75vh] content-center justify-items-center grid-cols-1 xl:grid-cols-5 bg-black">
        <img className="py-6 md:col-start-1 xl:col-start-2 xl:col-span-1 w-[50vw] md:w-20vw] sm:w-[35vw] xl:w-[15vw]" src={bag}  />
     {/* <img className="absolute z-10 top-1/2 right-0 transform -translate-x-1/2 -translate-y-1/2 xl:w-[14vw]" src={tote}  /> */}
      ...
      <h1 className="text-center text-lg md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-8xl my-10">COMING SOON</h1>
