...
async function loader3({ request }) {
  return console.log("REQUEST", request), await requireUserSession(request), getUserFromSession(request);
}
function AuthRoute() {
